...
a = frase.count('A')
pv = frase.find('A') + 1  # Somei 1 ao find porque a contagem dos caracteres começa a partir do 0 no python.
uv = frase.rfind('A') + 1  # Como ele mostra -1 quando a letra não é encontrada então ele se torna 0 nesse caso.
